...
func (s *MockBlockStore) SaveBlock(b *Block) error {
	s.saveBlockCalls++
...
func (s MockTransactionStore) SaveTransaction(t *Transaction) error {
	return nil
}
...
func (p MockEvmProvider) GetBlockByNumber(n int64) (Block, error) {
	return Block{}, nil
}
